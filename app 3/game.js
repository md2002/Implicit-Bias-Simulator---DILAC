...
let i1 =
  ...
  bAlign1 = [180, 175, 175, 175, 155, 170, 180, 170, 180, 170],
  bAlign2 = [520, 530, 535, 515, 520, 520, 520, 520, 520, 520],
  posWords = [
    "Superhero",
    "Innovator",
    "Leader",
...
function setup() {
  ...
  button1.position(350 + 10, 470);

  button2.position(350 + 15, 500);
  ...
  function clickbuttonDone() {
    ...
    posLen = posWords[i].length;
    negLen = negWords[i].length;
...
//   }
  ...
  function bt21() {
    button1.style("font-size", "20px");
    button1.position(bAlign1[i], 430);
    ...
    button2.position(bAlign2[i], 430);
    button2.style("font-family", "Times");
  ...
  function bt22() {
    button2.style("font-size", "20px");
    button2.position(bAlign1[i], 430);
    ...
    button1.style("font-size", "20px");
    button1.position(bAlign2[i], 430);
